...
# Train the random forest model with class weights for additional robustness
model = RandomForestClassifier(n_estimators=100, random_state=42, class_weight='balanced')  # Balanced weights help with any residual imbalance
